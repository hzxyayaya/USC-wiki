...
export function EditMenu({ webEditorUrl, githubUrl }: EditMenuProps) {
	return (
		<details className="relative">
			<summary className="cursor-pointer rounded-md border bg-fd-secondary px-3 py-1.5 text-sm font-medium text-fd-secondary-foreground marker:text-fd-muted-foreground transition-colors hover:bg-fd-accent hover:text-fd-accent-foreground active:translate-y-px focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fd-ring">
				编辑
			</summary>

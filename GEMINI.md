...
* **Language**: **All conversations, explanations, commit message explanations, AND PROJECT PLANS (Step-by-step breakdowns) MUST be in Chinese (Simplified).** (Please use Chinese to communicate with the user).
...
* **Verification**: Always run `bun run docs:build` to verify changes before considering a task complete.# USC Wiki - Project Context

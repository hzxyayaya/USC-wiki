...
本页展示 **Fumadocs 内置** 的 Markdown 排版与 MDX 组件。**不是**「整个站点 UI 的全部」（侧栏、搜索、主题切换等见文末清单）。Wiki / Obsidian 扩展见 [Markdown 语法示例](/gybz/markdown-demo/)。
...
<Cards>
<Card title="文档" description="浏览 Wiki 内容" href="/xxzn/" />
<Card title="关于本站" description="贡献与社区" href="/gybz/" />
